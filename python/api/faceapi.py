...
class SeetaFace(object):
    ...
    def _dll_func_def(self):
        ...
        self.InitEngine.argtypes = (POINTER(c_int32), c_int32)

        self.UnloadEngine = dll.UnloadEngine

        # todo 新增部分
        self.get_model_path = dll.get_model_path  # 获取模型文件目录,这样可以把模型文件位置乱放
        self.get_model_path.argtypes = [c_char_p]
        self.get_model_path.restype = c_void_p
